...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        l2 = new JLabel("Veteran:");
        l2.setFont(new Font("Raleway", Font.BOLD, 18));
        
        l3 = new JLabel("Ethnicity:");
        ...
        String veteran[] = {"I am a protected veteran","I am not a protected veteran.","I prefer not to say."};
        c1 = new JComboBox(veteran);
        c1.setBackground(Color.WHITE);
        c1.setFont(new Font("Raleway", Font.BOLD, 14));
        
        String Ethnicity[] = {"Hispanic or Latino","White","Black","Native Hawaiian","Asian", "Native American", "Two or More races", "I do not wish to disclose."};
        c2 = new JComboBox(Ethnicity);
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raleway", Font.BOLD, 14));
        
        String income[] = {"Null","< $10,275","> $10,275 &< $41,775","> $41,775 &< $89,075","> $89,075 &< $170,000","> $170,050"};
